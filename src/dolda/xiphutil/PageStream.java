...
public class PageStream {
	 ...
	 *
	 * @param in the Java IO <code>InputStream</code> to fetch pages from.
	 */
	 ...
	 *
	 * @return the page fetched, or <code>null</code> if at the end of the stream.
	 * @exception java.io.IOException if the <code>InputStream</code> itself
	 * throws an <code>IOException</code>.
	 * @exception FormatException if a format error is found in the stream.
	 */
